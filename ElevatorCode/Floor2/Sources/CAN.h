...
// Definitions for filters
  // Acceptance code definitions 
    #define ACC_CODE_ID101          0x2020        // ID100 (see AN3034 pg 10-11 for explanation)
...
// Definition of IDs
    #define ST_ID_202 0x40400000    // Standard ID 0x100 formatted to be loaded in IDRx registers in Tx buffer
    
extern volatile char rxdata[1];
// Function for initializing the CAN module
void CANInit(void);

// Function for transmitting CAN messages
unsigned char CANTx(unsigned long id, unsigned char priority, unsigned char length, unsigned int txdata);
