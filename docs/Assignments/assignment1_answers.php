  ...
  <body class='border'>
    ...
    <ol type="a">
      <li> What is a branch and how is it different from a <i>master</i> branch?</li>
            <ul><li>A branch is .... It's different from the master branch since the master branch is generally the "deployable" version whereas people mostly do development on the non-master branches.</li></ul>
      ...
      <br/><li> What happens when you initiate a <i>merge</i>?</li>
            <ul><li>When the merge is initiated,... </li></ul>
      <br/><li> Include a link to your hello-world repository, created in the hello-world activity</li>
            <ul><li><a href="#">Link to hello-world</a></li></ul>
    </ol>
    <p>Question 3:  Complete the two tutorials to deploy a remote website from github. <a href="#">Link to remote website</a></p>
    ...
    <p>Question 18: Create a custom button using an image rollover</p>
